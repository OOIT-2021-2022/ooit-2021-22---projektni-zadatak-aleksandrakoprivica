						...
						.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
							.addGroup(gl_panel.createSequentialGroup()
								...
								.addGroup(gl_panel.createParallelGroup(Alignment.LEADING, false)
									.addComponent(lblSecondY, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
									.addComponent(lblSecondX, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
									.addComponent(lblFirstY, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
									.addComponent(lblFirstX, GroupLayout.DEFAULT_SIZE, 239, Short.MAX_VALUE))
								.addGap(18)
								.addGroup(gl_panel.createParallelGroup(Alignment.LEADING, false)
									.addComponent(txtSecondY)
									.addComponent(txtSecondX)
									.addComponent(txtFirstY)
									.addComponent(txtFirstX, GroupLayout.DEFAULT_SIZE, 210, Short.MAX_VALUE)))
							.addGroup(gl_panel.createSequentialGroup()
								.addGap(172)
